...
var n,t,o = window,l = document,c = "mousemove",r = "mouseup",i = "mousedown",m = "EventListener",d = "add" + m,s = "remove" + m,f = [],u = function (e, m) {for (e = 0; e < f.length; )(m = f[e++]),(m = m.container || m),m[s](i, m.md, 0),o[s](r, m.mu, 0),o[s](c, m.mm, 0);for (f = [].slice.call(l.getElementsByClassName("dragscroll")), e = 0;e < f.length;
...
!(function () {var f = 0,x,y,t = 3;
document.addEventListener("mousedown", function (e) {x = e.clientX;y = e.clientY;f = 0;
});
document.addEventListener("mousemove", function (e) {if (!f &&(Math.abs(e.clientX - x) > t || Math.abs(e.clientY - y) > t))f = 1;
});
